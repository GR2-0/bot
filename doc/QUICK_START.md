...
## 📱 QR-регистрация: Команды для тестирования
...
/debug_meetups  # Отладка митапов

# Пользовательские команды
/points      # Проверка баланса поинтов
...
-   `src/utils/qr_registration.py` - система QR-регистрации
...
-   **QR-регистрация на митапы** - автоматическая генерация QR-кодов каждые 30 секунд
-   **Глубокие ссылки** - пользователи могут регистрироваться, переходя по ссылкам из QR-кодов
-   **Автоматическая очистка** - старые QR-файлы удаляются автоматически
-   **Интеграция с поинтами** - автоматическое начисление поинтов за посещение митапов

## 📚 Документация

-   `README.md` - полная документация проекта
-   `INSTALL.md` - подробная инструкция по установке
-   `doc/QR_REGISTRATION.md` - документация по системе QR-регистрации
-   `doc/Manual_testing.md` - руководство по ручному тестированию

---

_Готово к продолжению работы! 🎯_
